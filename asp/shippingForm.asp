...
<%
	...
	if continue = "continue" Then
		showerrors = "true"
		if firstname = "" or lastname = "" or address1 = "" or city = "" or statecode = "" or zip = "" Then
			iserror = "true"
		else
			processShipping()
		end if		
	elseif addrlocchange = "true" or continue = "" Then
		showerrors = "false"
	end if
...
function changeAddrLoc(addrObj){
	shippingForm.addrlocchange.value = "true";
	shippingForm.submit();
}
</script>
...
<tr>
	<td colspan="3" class="lrggray">Shipping Information</td>
</tr>
<tr>
...
<tr>
	<td colspan="3" class="medred">Shipping Address</td>
</tr>
<tr>
