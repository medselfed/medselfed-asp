...
<div class="lrlines">
	...
	<table cellpadding="0" cellspacing="10" width="95%"><tr><td>
	  ...
	  <form name="form2" method="post" action="">
	    ...
	    <p class="sml" align="justify"><font class="lrgred">PreOp Surgery Centers <span class="style1">@ $24.95 each per month.</span></font><br>
	  <br>
	      <input type="checkbox" name="heart" value="checkbox">
	    PreOp Cardiac Center <a href="http://mkt.medselfed.com/asp/center.asp?centerId=heart" target="_blank"><span class="style3">(view)</span></a> <br>
	    <input type="checkbox" name="women" value="checkbox">
	    PreOp Women's Center  <a href="http://mkt.medselfed.com/asp/center.asp?centerId=womens" target="_blank"><span class="style3">(view)</span></a> <br>
	    <input type="checkbox" name="checkbox2" value="checkbox">
	    PreOp Minimal Surgery Center  <a href="http://mkt.medselfed.com/asp/center.asp?centerId=lap" target="_blank"><span class="style3">(view)</span></a> <br>
	    <input type="checkbox" name="checkbox3" value="checkbox">
	    PreOp Orthopedic Center <a href="http://mkt.medselfed.com/asp/center.asp?centerId=ortho" target="_blank"><span class="style3">(view)</span></a> <br>
	    <input type="checkbox" name="checkbox4" value="checkbox">
	  PreOp Oncology Center <a href="http://mkt.medselfed.com/asp/center.asp?centerId=onco" target="_blank"><span class="style3">(view)</span></a> <br>
	  <br>
